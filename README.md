...
<p align="center">
  <a href="https://linkedin.com/in/thomasosoriozambrano">
    <img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white" />
  </a>
  <a href="mailto:tosorioz@eafit.edu.co">
...
I build backend systems and AI-powered pipelines with end-to-end ownership — from API design to deployment and observability. I care about systems that are simple, reliable, and solve real problems for real users.

Currently focused on: **agentic AI systems**, **LLM orchestration**, and **event-driven backends**.
...
`FastAPI` `LangGraph` `GPT-4o-mini` `ChromaDB` `Prometheus` `Loki` `Grafana` `Docker`
...
### ⛓️ [OriginPass — Product Authenticity on Monad](https://github.com/Handoo-co/Monad)
> MonadBlitz Medellín Hackathon · Jun 2026

On-chain passport system for physical product certification. Brands issue immutable certificates per serial number; buyers verify authenticity in ~400ms via QR scan on Monad Testnet.

`Solidity` `Foundry` `Monad Testnet` `wagmi` `RainbowKit` `React 19`
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=thomaszambrano&show_icons=true&theme=tokyonight&hide_border=true&count_private=true" height="150"/>
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=thomaszambrano&layout=compact&theme=tokyonight&hide_border=true" height="150"/>
</p>
